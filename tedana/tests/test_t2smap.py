...
class TestT2smap:
    def test_basic_t2smap1(self):
        ...
        workflows.t2smap_workflow(
            data, [14.5, 38.5, 62.5], combmode="t2s", fitmode="all", label="t2smap"
        )
    ...
    def test_basic_t2smap2(self):
        ...
        workflows.t2smap_workflow(
            data, [14.5, 38.5, 62.5], combmode="t2s", fitmode="ts", label="t2smap"
        )
        out_dir = "TED.echo1.t2smap"
    ...
    def test_basic_t2smap3(self):
        ...
        workflows.t2smap_workflow(
            data, [14.5, 38.5, 62.5], combmode="ste", fitmode="all", label="t2smap"
        )
        out_dir = "TED.echo1.t2smap"
    ...
    def test_basic_t2smap4(self):
        ...
        workflows.t2smap_workflow(
            data, [14.5, 38.5, 62.5], combmode="ste", fitmode="ts", label="t2smap"
        )
        out_dir = "TED.echo1.t2smap"
