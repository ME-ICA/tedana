...
def check_integration_outputs(
    ...
    unexpected_files : list[str]
        ...
        the files are not expected to be present. Default is None
    log_prefix : str
        The prefix of the log file name. Default is "tedana_". This is used to find the log file
        in the output directory. It can be changed if a test uses a different prefix for the log
        file name.
    """
    ...
    # Checks for log file
    log_regex = f"^{log_prefix}" + "[12][0-9]{3}-[0-9]{2}-[0-9]{2}T[0-9]{2}[0-9]{2}[0-9]{2}.tsv$"
...
def test_integration_t2smap(skip_integration):
    ...
    check_integration_outputs(fname, out_dir, log_prefix="t2smap_")
