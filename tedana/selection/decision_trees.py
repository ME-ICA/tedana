...
from tedana.selection.decision_tree_ancillary import comfirm_metrics_calculated
import tedana.selection.selection_nodes
...
def manual_selection(comptable, acc=None, rej=None):
    ...
    def minimal_decision_tree_A(comptable, n_echos, n_vols):
        """
        ...
        necessary_metrics = ['kappa', 'rho', 
                             'count_sig_in_T2cluster', 'count_sig_in_S0cluster', # currently countsigR2 and countsigS0
                             'DICE_FT2', 'DICE_FS0',
        ...
        comptable, decision_tree_steps, tmp_necessary_metrics = RhoGtKappa(
            comptable, iftrue='reject', iffalse='no_change',
