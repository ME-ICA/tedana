...
def confirm_metrics_exist(comptable, necessary_metrics, functionname=None):
    ...
    already included in comptable. Note 
...
def are_only_necessary_metrics_used(used_metrics=used_metrics, 
        necessary_metrics=necessary_metrics, functionname=functionname):
    """
