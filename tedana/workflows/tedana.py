...
def tedana_workflow(
    ...
    tree : {'tedana_v0.013', 'meica', 'minimal', 'json file'}, optional
        Decision tree to use for component selection. Can be a
        packaged tree (tedana_v0.013, meica, minimal) or a user-supplied JSON file that
        matches the decision tree file specification. tedana_v0.013 is the tree that has
        ...
        differences is ongoing. Default is 'tedana_v0.013'.
